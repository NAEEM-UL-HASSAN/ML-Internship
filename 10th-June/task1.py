...
def main():
    ...
    relevant_columns = ['ORDERNUMBER', 'QUANTITYORDERED', 'PRICEEACH', 'SALES','PRODUCTLINE']
    ...
    top_selling_product = df.groupby('PRODUCTLINE')['QUANTITYORDERED'].sum().reset_index().sort_values(by='QUANTITYORDERED', ascending=False).iloc[0]
    print("\nTop selling product:")
